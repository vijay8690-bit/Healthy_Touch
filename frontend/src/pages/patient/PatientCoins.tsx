...
import { Calendar, Coins, Copy, FileText, Gift, LayoutDashboard, Search, Share2, ShoppingCart, User, Users } from 'lucide-react';
...
export default function PatientCoins() {
        ...
        <div className="card-healthcare p-6">
          ...
          {loading ? (
            ...
            <div className="py-10 text-center">
              ...
              <p className="text-sm text-muted-foreground">Book services or share your referral code to earn coins.</p>
            </div>
          ) : (
